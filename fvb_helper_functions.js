...
function make_profile_plot(plot_data,float_param,bottle_param,plot_title,selected_wmo,selected_units,selected_cruise){
  ...
  var bottle_trace = {
      ...
      name: "Bottle Data",
      opacity: 0.7,
      marker: {line: {width: 0.3},size: 6, opacity: 0.7, color: '#0397A8'},
      xaxis: "x1",
      yaxis: "y1"
    }
    ...
    var float_trace = {
      ...
      name: 'Float Data',
      opacity: 0.7,
      marker: {line: {width: 0.3}, size: 6, opacity: 0.7, color: '#F89D28'},
      xaxis: "x1",
      yaxis: "y1"
    }
...
function make_anomaly_plot(plot_data,float_param,bottle_param,plot_title,selected_wmo,selected_units){
  ...
  var diff_trace = {
      ...
      name: "Bottle Data",
      opacity: 0.7,
      marker: {line: {width: 1},size: 5, opacity: 0.7, color: '#0397A8'},
      xaxis: "x1",
      yaxis: "y1"
    }
...
function make_summary_plot(plot_data,float_param,bottle_param,plot_title,max_dist,selected_wmo,selected_cruise){
  ...
  //If distance parameter selected, bottle_param will be "". In this case,
  //set diff data to float data.
  if(bottle_param === ""){
    diff_data = float_data
  }
...
function prep_distance_table(cruise_data,wmo_data,dist_data,selected_wmo,max_dist,selected_cruise){
  //Calculate average distances for each cruise/wmo
